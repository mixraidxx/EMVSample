...
public class MainActivity extends AppCompatActivity implements OnCardInfoListener, OnEmvProcessListener2, OnPinPadInputListener {
    ...
    private EmvHandler2 emvHandler;            //The EmvHandler is used for managing the emv process through a transaction on the terminal
    ...
    public void onCardInfo(int retCode, CardInfoEntity cardInfo) {
        ...
        if (retCode == SdkResult.Success && cardInfo != null) {
           ...
           // emvTransDataEntity.setTransAmt(leftPad(transAmount, 12, '0'));
            emvTransDataEntity.setTransAmount(leftPad(transAmount,12,'0'));
